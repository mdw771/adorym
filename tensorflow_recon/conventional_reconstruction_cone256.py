...
dxchange.write_tiff_stack(np.abs(dat_exit) ** 2, 'cone_256/conventional_recon/bp0/wave', overwrite=True, dtype='float32')
...
dxchange.write_tiff_stack(dat_retrieved, 'cone_256/conventional_recon/bp/wave', overwrite=True, dtype='float32')
...
dat_retrieved = tomopy.retrieve_phase(dat_retrieved,
                                      ...
                                      energy=5,
                                      alpha=1e-3)
dxchange.write_tiff_stack(dat_retrieved, 'cone_256/conventional_recon/pr/proj', overwrite=True, dtype='float32')
...
rec = tomopy.recon(dat_retrieved,
                   theta=theta,
                   algorithm='gridrec')
dxchange.write_tiff_stack(tomopy.circ_mask(rec, 0, ratio=0.9), 'cone_256/conventional_recon/recon/recon', overwrite=True, dtype='float32')
